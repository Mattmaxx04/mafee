    ...
    <div class="d-flex justify-content-center form-img">
        ...
        <div class="tab-content p-4 p-md-5">
            <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                <h3 class="mb-4">RESERVATION ENQUIRY</h3>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingThree">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                ...
                WHICH SEATTLE BREWERIES WILL WE VISIT?
              </button>
            </h2>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingSix">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                ...
                WHAT IS INCLUDED ON A SEATTLE BREWERY TOUR?
              </button>
            </h2>
...
.home__discover {
    ...
    align-items: center;
    background-image: url("../assets/contact-title-img.jpg");
